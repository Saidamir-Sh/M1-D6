...
me.skills = ["JavaScript", "TypeScript", "C++"]
console.log(me)
...
const countMovies = function (moviesArr13) {
  console.log("Total movies are : " + moviesArr13.length)
}
...
const onlyTitles = function (moviesArr14) {
  let moviesTitle = []

  for (let i = 0; i < moviesArr14.length; i++) {
    moviesTitle.push(moviesArr14[i].Title)
  }
